...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/scrollbar.js":[function(require,module,exports) {
"use strict";
...
function scrollBar(data, fn) {
  ...
  data.forEach(function (item, index, array) {
    ...
    menu.innerHTML = "".concat(item.term);
    menu.addEventListener('click', function (e) {
      var select = parseInt(menu.dataset.index) + 1;
      fn(select);
    }, false);
...
var cardIndex = document.querySelector('.index');
...
function init(e) {
  var scriptURL = 'https://script.google.com/macros/s/AKfycbwFv0BgJDh-HtzeMYRhchSH66V51CSOZ7GP70hY4p0GiscZ6O7gbzdSnGXOgy2JrV5i/exec';
  fetch(scriptURL).then(function (res) {
    ...
    loadPage(1);
    (0, _scrollbar.default)(card.contents, loadPage);
    console.log(card.contents);
  });
}

function arrayToObject(sheetData) {
  var res = sheetData.map(function (_ref) {
...
function loadPage(index) {
  ...
  cardIndex.innerHTML = "".concat(parseInt(card.currentPage), " / ").concat(card.contents.length - 1); // Add event listener
...
function showDefinition(e) {
  ...
  var def = card.contents[card.currentPage - 1].def;
  answer.innerHTML = "<p>".concat(def, "</p>"); // loadPage(card.currentPage);
}
},{"../css/style.css":"css/style.css","./scrollbar":"js/scrollbar.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
